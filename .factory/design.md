...
The LT waveform app icon is an original hand-authored SVG using only the product tokens; 192px and 512px raster exports were made locally with ImageMagick. No stock assets are used.
