...
| The demo opens three dialogue takes to compare. | 8 | Pass |
...
| Group takes by filename | 4 | Pass |
...
| Line Take Match does not transcribe, generate, or clone voices. | 10 | Pass |
| Measurements are review cues, never performance scores. | 7 | Pass |
| Keep larger take lists together | 5 | Pass |
| Free mode includes 12 takes and CSV exports. | 8 | Pass |
| Studio costs $19 once and adds unlimited takes and audio backups. | 11 | Pass |
| Compare recorded voice takes without uploading audio. | 7 | Pass |
...
| Free mode compares up to 12 takes and includes CSV export. | 10 | Pass |
| Studio costs $19 once. | 4 | Pass |
| It adds unlimited takes and portable project backups. | 8 | Pass |
| Unlimited takes and lines on this device | 7 | Pass |
| Download a backup with your audio | 6 | Pass |
